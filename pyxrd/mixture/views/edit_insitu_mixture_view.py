...
class EditInSituMixtureView(BaseView):   
    ...
    def _add_new_phase_behav_combo(self, 
        ...
        box.pack_start(new_phase_combo, padding = 2)
        box.pack_end(new_behav_combo, padding = 2)
       
        self.matrix.attach(box, self.base_width + r, self.base_width + r + 1, self.base_height + c, self.base_height + c + 1, gtk.EXPAND | gtk.FILL, 0)
