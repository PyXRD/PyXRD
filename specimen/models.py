...
class Specimen(ChildModel, Storable, ObjectListStoreParentMixin, ObjectListStoreChildMixin):
    ...
    __model_intel__ = [
        ...
        PropIntel(name="sample_name",          label="Sample",                             ctype=str,    is_column=True,  storable=True,   has_widget=True),
        PropIntel(name="label",                label="Label",                              ctype=str,    is_column=True),        
        PropIntel(name="sample_length",        label="Sample length [cm]",                 ctype=float,  minimum=0.0,     is_column=True,  storable=True,    has_widget=True),
        PropIntel(name="abs_scale",            label="Absolute scale [counts]",            ctype=float,  minimum=0.0,     is_column=True,  storable=True,    has_widget=True),
        PropIntel(name="bg_shift",             label="Background shift [counts]",          ctype=float,  minimum=0.0,     is_column=True,  storable=True,    has_widget=True),
        PropIntel(name="absorption",           label="Absorption coeff. (µ*g)",            ctype=float,  minimum=0.0,     is_column=True,  storable=True,    has_widget=True),
        PropIntel(name="display_calculated",   label="Display calculated diffractogram",   ctype=bool,   is_column=True,  storable=True,   has_widget=True),
        PropIntel(name="display_experimental", label="Display experimental diffractogram", ctype=bool,   is_column=True,  storable=True,   has_widget=True),
        PropIntel(name="display_phases",       label="Display phases seperately",          ctype=bool,   is_column=True,  storable=True,   has_widget=True),
        PropIntel(name="display_stats_in_lbl", label="Display Rp in label",                ctype=bool,   is_column=True,  storable=True,   has_widget=True),
        PropIntel(name="calculated_pattern",   label="Calculated diffractogram",           ctype=object, is_column=True,  storable=True,   has_widget=True),
        PropIntel(name="experimental_pattern", label="Experimental diffractogram",         ctype=object, is_column=True,  storable=True,   has_widget=True),
        PropIntel(name="exclusion_ranges",     label="Excluded ranges",                    ctype=object, is_column=True,  storable=True,   has_widget=True),
        PropIntel(name="markers",              label="Markers",                            ctype=object, is_column=True,  storable=True),
        PropIntel(name="statistics",           label="Statistics",                         ctype=object, is_column=True),
        PropIntel(name="calc_color",           label="Calculated color",                   ctype=str,    is_column=True,  storable=True,   has_widget=True),
        PropIntel(name="inherit_calc_color",   label="Use default color",                  ctype=bool,   is_column=True,  storable=True,   has_widget=True),
        PropIntel(name="exp_color",            label="Experimental color",                 ctype=str,    is_column=True,  storable=True,   has_widget=True),
        PropIntel(name="inherit_exp_color",    label="Use default color",                  ctype=bool,   is_column=True,  storable=True,   has_widget=True),
    ...
    @Model.getter("sample_name", "name", "display_calculated",
        "display_experimental", "display_phases", "display_stats_in_lbl")
    def get_name(self, prop_name):
        return getattr(self, "_%s" % prop_name)
    @Model.setter("sample_name", "name", "display_calculated", 
        "display_experimental", "display_phases", "display_stats_in_lbl")
    ...
    # ------------------------------------------------------------
    def __init__(self, name="", sample_name="", sample_length=0.0,
                 abs_scale=1.0, bg_shift=0.0, absorption = 0.9,
    ...
    def from_experimental_data(parent, format="DAT", filename=""):
        ...
        if format=="DAT":        
            ...
            with open(filename, 'r') as f:
                ...
                specimen.experimental_pattern.load_data(data=f, format=format, has_header=False, clear=True)
            
            specimen.name = u(os.path.basename(filename))
            specimen.sample_name = u(header)
            ...
            f = open(filename, 'rb')
            f.seek(146)
            specimen.sample_name = u(str(f.read(16)).replace("\0", ""))
            specimen.name = u(os.path.basename(filename))
            specimen.experimental_pattern.load_data(data=f, format=format, clear=True)
            f.close()
...
class ThresholdSelector(ChildModel):
    ...
    __model_intel__ = [ #TODO add labels
        PropIntel(name="pattern",                 ctype=str,    storable=True,    has_widget=True),
        PropIntel(name="max_threshold",           ctype=float,  storable=True,    has_widget=True),
        PropIntel(name="steps",                   ctype=int,    storable=True,    has_widget=True),
        PropIntel(name="sel_threshold",           ctype=float,  storable=True,    has_widget=True),
        PropIntel(name="sel_num_peaks",           ctype=int,    storable=True,    has_widget=True),
        PropIntel(name="threshold_plot_data",     ctype=object, storable=True),
    ]
...
class Marker(ChildModel, Storable, ObjectListStoreChildMixin, CSVMixin):
    ...
    __parent_alias__ = 'specimen'
    __model_intel__ = [ #TODO add labels
        PropIntel(name="label",         ctype=str,   storable=True, has_widget=True, is_column=True),
        PropIntel(name="visible",       ctype=bool,  storable=True, has_widget=True),
        PropIntel(name="position",      ctype=float, storable=True, has_widget=True),
        PropIntel(name="x_offset",      ctype=float, storable=True, has_widget=True),
        PropIntel(name="y_offset",      ctype=float, storable=True, has_widget=True),
        PropIntel(name="color",         ctype=float, storable=True, has_widget=True),
        PropIntel(name="base",          ctype=float, storable=True, has_widget=True),
        PropIntel(name="angle",         ctype=float, storable=True, has_widget=True, inh_name="inherit_angle"),
        PropIntel(name="inherit_angle", ctype=bool,  storable=True, has_widget=True),
        PropIntel(name="style",         ctype=str,   storable=True, has_widget=True),
        PropIntel(name="needs_update",  ctype=object),
    ]
    ...
    def __init__(self, label=None, visible=None, position=None, 
        ...
        self.base = int(base or self.get_depr(kwargs, 1, "data_base"))
...
class Statistics(ChildModel):
    ...
    __parent_alias__ = 'specimen'
    __model_intel__ = [ #TODO add labels
        PropIntel(name="points",            ctype=int,   has_widget=True),
        PropIntel(name="residual_pattern",  ctype=object),
        PropIntel(name="chi2",              ctype=float, has_widget=True),
        PropIntel(name="Rp",                ctype=float, has_widget=True),
        PropIntel(name="R2",                ctype=float, has_widget=True),
    ]
    ...
    def update_statistics(self):
        ...
        try:
            if cal_y != None and exp_y != None and cal_y.size > 0 and exp_y.size > 0:
                ...
                self.Rp, self.R2 = self._calc_RpR2(e_ey, e_cy)
            else:
