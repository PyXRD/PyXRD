...
from test.test_generic.test_models.test_treemodels.test_base import TestBaseObjectListStoreMixin
...
class TestObjectListStore(TestBaseObjectListStoreMixin, unittest.TestCase):
    ...
    def test_operations(self):
        ...
        self.assertEqual(self.store.get_item_by_index(0), self.obj1)
        ...
        self.assertEqual(self.store.get_item_by_index(0), self.obj1)
        self.assertEqual(self.store.get_item_by_index(1), self.obj2)
        self.store.reposition_item(self.obj2, 0)
        self.assertEqual(self.store.get_item_by_index(0), self.obj2)
